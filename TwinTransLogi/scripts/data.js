...
window.BOOK_DATA = {
  ...
  chapters: {
    ...
    ch08: {
      ...
      dialogue: [
        ...
        { who: 'A', text: 'B2C 95%、B2B 98%、溫控藥品 99.5%。OTIF 是準時 + 全量無缺件 + 無錯送 + 無破損四項全 AND——倉儲篇五章的綜合 KRI。' }
      ],
  ...
  trialQuestions: [
    ...
    { ch: 'ch08', q: 'OTIF 包含哪四項全 AND 條件？', opts: ['準時 + 全量 + 無錯送 + 品質無破損', '準時 + 滿載 + 一次結帳 + 客戶滿意', '時效 + 成本 + 品質 + 碳排', '訂單 + 派車 + 送貨 + 簽收'], ans: 'A', exp: 'OTIF = On-Time In-Full：準時送達 + 全量無缺件 + 無錯送 + 品質無破損四項全 AND，倉儲篇五章綜合 KRI。' },
